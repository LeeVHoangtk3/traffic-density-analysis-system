 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "    <p style=\"font-size: 1.15em; opacity: 0.95; margin-bottom: 0;\">Hệ Thống Phân Tích Mật Độ Giao Thông & Tối Ưu Đèn Tín Hiệu AI</p>\n",
    "</div>\n",
    "\n",
    ...
    "3. **Frontend Dashboard (React)**: Giao diện trực quan hóa thông tin mật độ giao thông, lịch sử ùn tắc và mô phỏng đèn tín hiệu thời gian thực.\n",
    "4. **ML Service (LightDeltaModel)**: Dự báo mật độ giao thông ở chu kỳ tiếp theo và đề xuất điều chỉnh pha đèn (Green Time Delta).\n",
    "5. **Integration Pipeline (system_runner)**: Bộ điều phối trung tâm chạy vòng lặp tuần hoàn để kiểm tra dữ liệu, tính toán ùn tắc và tối ưu pha đèn.\n",
    "\n",
    "---\n",
    "\n",
  ...
  },
  {
   ...
   "source": [
    ...
    "    name=\"integration\",\n",
    "    cmd=[\"python\", \"integration_system/system_runner.py\"],\n",
  ...
  },
  {
   ...
   "source": [
    ...
    ")\n",
    "\n",
    "# 4. Khởi chạy Integration Pipeline độc lập (chỉ làm nhiệm vụ điều phối và gọi tối ưu pha đèn)\n",
    "manager.start_service(\n",
    "    name=\"integration\",\n",
    "    cmd=[\"python\", \"integration_system/system_runner.py\"],\n",
  ...
  },
  {
   ...
   "outputs": [],
   "source": [
    "# Ví dụ: Xem 15 dòng logs mới nhất của bộ điều phối tối ưu đèn (Integration)\n",
...
# Write notebook to run_system.ipynb in the root
project_root = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
notebook_path = os.path.join(project_root, "run_system.ipynb")

with open(notebook_path, "w", encoding="utf-8") as f:
    json.dump(notebook, f, ensure_ascii=False, indent=1)

print(f"Generated Jupyter Notebook successfully at: {notebook_path}")
